...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		request.setAttribute("oldPassword", PropertyReader.getValue("error.pass", "password"));
		pass = false;
	}
		if (DataValidator.isNull(request.getParameter("newPassword"))) {
			...
			pass = false;
			  ...
			  request.setAttribute("confirmPassword","Old Password & New Password can not be same!!");
		...
		/*else if (!DataValidator.isEmail(request.getParameter("confirmPassword"))) {
			request.setAttribute("confirmPassword", PropertyReader.getValue("error.pass", "password"));
			pass = false;
		}
		*/ 

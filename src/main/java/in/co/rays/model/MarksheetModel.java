...
//		System.out.println("marksheet model >>>>>>>><<<<<"+studentbean);
		bean.setName(studentbean.getFirstName() + " " + studentbean.getLastName());
		
//System.out.println(studentbean.getFirstName() + " >>>>><<<======" + studentbean.getLastName());
//		System.out.println("marksheet model >>>>>>>>"+bean);
	...
	public void update(MarksheetBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			System.out.println("inside update model methd");
	...
	public List getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("get meritlist started");
		ArrayList list = new ArrayList();
//		StringBuffer sql = new StringBuffer("SELECT `ID`,`ROLL_NO`, `NAME`, `PHYSICS`, `CHEMISTRY`, `MATHS` , (PHYSICS + CHEMISTRY + MATHS) as total from `ST_MARKSHEET` order by total desc");
		StringBuffer sql = new StringBuffer("SELECT `ID`,`ROLL_NO`, `NAME`, `PHYSICS`, `CHEMISTRY`, `MATHS` , (PHYSICS + CHEMISTRY + MATHS) as total from `ST_MARKSHEET`where not(PHYSICS <33 or CHEMISTRY<33 or MATHS<33) order by total desc");
		if (pageSize > 0) {
			pageNo =( pageNo - 1 )* pageSize;
			sql.append(" limit " + pageNo + "," + pageSize);
			Connection conn = null;

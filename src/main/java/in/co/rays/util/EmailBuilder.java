...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("<H1>Hi! Greetings for SunilOS</H1>");
		msg.append(
				"<P>Congratulations Congratulations for registering on ORS! You can now access your ORS account online - anywhere, anytime and enjoy the flexibility to check the Marksheet Details </P>");
		msg.append(
	...
	/**
	 * Gets the change pass word message.
	 *
	 * @param map the map
	 * @return the change pass word message
	 */
